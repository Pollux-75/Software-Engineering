...
string int_to_char_to_string(int a)				// int转string
{
...
bool eng_sign(char c_temp)		// 英文符号
{
...
// 完整拼音识别
void put_full_pinyin_into_words_hash(string word_string_temp,int word_num, unordered_map<string, word>* head_hash, unordered_map<string, word>* tail_hash, bool isEnd)
{
...
// 首字母拼音识别
void put_head_pinyin_into_words_hash(string word_string_temp, int word_num, unordered_map<string, word>* head_hash, unordered_map<string, word>* tail_hash, bool isEnd)
{
...
void have_words(int i,int l, unordered_map<string, word>* get_now_hash)	//从下一句话下标i开始检测
{
